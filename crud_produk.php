...
session_start();            // kalau nanti mau batasi ke admin
            ...
            <?php if ($produk->num_rows): $no=1; ?>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <img src="<?= $row['gambar'] ?>" alt="" style="width:60px;height:60px;object-fit:cover;border-radius:8px">
                ...
                <div class="modal fade" id="editModal<?= $row['id_barang'] ?>" tabindex="-1" aria-hidden="true">
